  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[90vh]">
        ...
        {/* Header */}
        <div className="flex items-start gap-3 px-6 py-4 border-b border-gray-200 shrink-0">
          <div className="p-2 bg-indigo-100 rounded-xl">
            <Bot size={20} className="text-indigo-600" />
          </div>
          <div className="flex-1 min-w-0">
            <h2 className="font-semibold text-gray-900">AI Agent Prompt</h2>
        ...
        <div className="flex-1 overflow-hidden flex flex-col px-6 py-4 gap-3">
          ...
          {loading ? (
            ...
            <pre className="flex-1 overflow-auto bg-gray-50 border border-gray-200 rounded-xl p-4 text-xs font-mono text-gray-700 whitespace-pre-wrap leading-relaxed">
              {prompt}
            </pre>
          )}
        </div>
